                ...
                <div class="card-body p-5">
                  ...
                  <form @submit.prevent="handleSignin">
                    ...
                    <div class="d-flex justify-content-center">
                      <button type="submit" class="btn gradient-custom-4 text-body">Sign In</button>
                    </div>
  
                    <p class="text-center text-muted mt-5 mb-0"> Don't have an account?
                      <router-link :to="{ name: 'signup' }"><u>Registration</u></router-link>
                    </p>
                  </form>
  ...
  export default {
    ...
    methods: {
      async handleSignin() {
          ...
          await this.$store.dispatch('sign_in', this.formData);
          this.error = null;
...
.bg-image {
    background-image: url('https://img.freepik.com/premium-photo/restaurant-manager-briefing-his-kitchen-staff-commercial-kitchen_109285-2448.jpg');
